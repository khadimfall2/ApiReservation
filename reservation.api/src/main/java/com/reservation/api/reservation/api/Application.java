...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * spectateurs.forEach(spectateur->System.out.println(spectateur.
		 * getNonSpectateur()));
		 * 
		 * System.out.println(""); Optional <Reservation> choixReservations =
		 * reservationService.getReservationById(2);
		 * 
		 * Reservation reservation1 = choixReservations.get();
		 * 
		 * System.out.println(reservation1.getDateReservation());
		 * 
		 * reservation1.getSpectateurs().forEach (spectateur
		 * ->System.out.println(spectateur.getPrenomSpectateur())); FIN UN A PLUSIEURS
		 * ENTRE RESERVATION ET SPECTATEUR
		 * 
		 */
		...
		Optional<Client> optClient = clientService.getClienById(2);
		...
		clientService.getAllClient().forEach(client -> System.out.println(client.getTelClient()));// client parametre de
																									// getAllclient
		...
		filmService.getAllFilm().forEach(film -> System.out.println(film.getDuree()));
